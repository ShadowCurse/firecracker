...
//     pub device: ManuallyDrop<File>,
//     pub flags: u32,
//     pub regions: Vec<VfioRegion>,
//     pub irqs: HashMap<u32, VfioIrq>,
//     pub sysfspath: PathBuf,
//     pub vfio_ops: Arc<dyn VfioOps>,
// }
//
// impl VfioDevice {
//     #[cfg(not(test))]
...
//
//     impl VfioGroup {
//         pub fn open_group_file(id: u32) -> Result<File> {
...
//
//     impl VfioDevice {
//         pub fn get_group_id_from_path(_sysfspath: &Path) -> Result<u32> {
//             Ok(3)
//         }
//     }
//
