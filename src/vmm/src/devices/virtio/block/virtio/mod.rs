...
pub const BLOCK_CONFIG_SPACE_SIZE: usize = 40;
...
pub const BLOCK_NUM_QUEUES: usize = 2;
pub const BLOCK_QUEUE_SIZES: [u16; BLOCK_NUM_QUEUES] =
    [FIRECRACKER_MAX_QUEUE_SIZE, FIRECRACKER_MAX_QUEUE_SIZE];
