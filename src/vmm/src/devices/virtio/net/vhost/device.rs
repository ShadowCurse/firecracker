...
use crate::devices::virtio::net::virtio::device::{vnet_hdr_len, ConfigSpace};
use crate::devices::virtio::net::virtio::tap::Tap;
use crate::devices::virtio::net::virtio::{NetError, NET_QUEUE_SIZES, RX_INDEX, TX_INDEX};
...
type KernelVhostNet = vhost::vhost_kern::net::Net<Arc<GuestMemoryMmap>>;
...
pub struct VhostNet {
    ...
    pub(crate) vhost: Option<KernelVhostNet>,
...
impl VhostNet {
    ...
    fn setup_vhost_handle(&mut self, mem: &GuestMemoryMmap) -> Result<(), VhostError> {
        let vhost = KernelVhostNet::new(Arc::new(mem.clone()))?;
